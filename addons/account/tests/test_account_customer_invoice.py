...
class TestAccountCustomerInvoive(AccountTestUsers):
    ...
    def test_customer_invoice(self):
        ...
        self.account_rec1_id = self.AccountAccount.sudo(self.account_user.id).create(dict(
            code="cust_acc",
        ...
        self.account_invoice_customer0 = self.AccountInvoice.sudo(self.account_user.id).create(dict(
        ...
        AccountInvoiceRefund = self.env['account.invoice.refund']
        self.account_invoice_refund_0 = AccountInvoiceRefund.create(dict(
