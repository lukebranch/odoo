(function() {
    ...
    var _t = openerp._t;
    var widgets = website.widgets = website.widgets || {};
    ...
    website.TopBarCustomize = openerp.Widget.extend({
        events: {
    ...
    website.TopBar.include({
        start: function () {
            ...
            this.customize_menu.setElement($('li[id=customize-menu]'));
            this.customize_menu.start();
            return this._super();
        }
    });
...
define(['summernote/openerp'], function () {
    ...
    web_editor.widgets.LinkDialog.include({
        bind_data: function () {
            var self = this;
