...
class TestHolidaysFlow(TestHrHolidaysCommon):
    ...
    def test_00_leave_request_flow(self):
        ...
        holidays = self.HrHolidays.search([('name', '=', 'Holiday21')])
        holidays.unlink()
        ...
        holidays = self.HrHolidays.search([('name', '=', 'Holiday22')])
        holidays.unlink()
        ...
        holidays21.sudo(user=self.res_users_hr_officer).signal_workflow('refuse')
        holidays21.refresh()
        ...
        # By mistake this leave request, I click on "Refuse" button
        ...
        # Correct my mistake by clicking on "Reset to Draft" button
        ...
        # Now in draft stage, I click on "Confirm" button
