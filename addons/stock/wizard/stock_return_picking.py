...
class stock_return_picking(osv.osv_memory):
    ...
    def _create_returns(self, cr, uid, ids, context=None):
        ...
        return_move_ids = [move.move_id.id for move in data_obj.browse(cr, uid, data['product_return_moves'], context=context)]
        moves_to_unreserve = []
        for move in pick.move_lines:
            to_check_moves = [move.move_dest_id] if move.move_dest_id.id and move.id in return_move_ids else []
