...
class TestStockFlow(TestStockCommon):
    ...
    def test_00_picking_create_and_trasfer_quantity(self):
    ...
    def test_00_pickings_transfer_with_different_uom(self):
        """ Picking transfer with diffrent unit of messure. """

        # ----------------------------------------------------------------------
        # Create incoming shipment of product DozA, SDozA, SDozARound, kgB, gB
        # ----------------------------------------------------------------------
        ...
        # ----------------------------------------------------------------------
        # Check product quantity and unit of messure of pack operaation.
        # ----------------------------------------------------------------------

        # Check pack operation quantity and unit of messure for product DozA.
        ...
        # Check pack operation quantity and unit of messure for product SDozA.
        ...
        # Check pack operation quantity and unit of messure for product SDozARound.
        ...
        # Check pack operation quantity and unit of messure for product gB.
        ...
        # Check pack operation quantity and unit of messure for product kgB.
        ...
        self.assertEqual(move.product_uom.id, self.uom_tone.id, 'Wrong unit of messure in done move.')
    ...
    def test_20_create_inventory_with_different_uom(self):
        """Create inventory with different unit of messure."""
