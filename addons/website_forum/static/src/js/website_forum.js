odoo.define('website_forum.website_forum', ['web.ajax', 'website.website'], function (require) {
'use strict';
...
website.if_dom_contains('.website_forum', function () {
    ...
    $('.link_url').on('change', function (ev) {
        ...
        if ($link.attr("value").search("^http(s?)://.*")) {
            ...
            ajax.jsonRpc("/forum/get_url_title", 'call', {'url': $link.attr("value")}).then(function (data) {
