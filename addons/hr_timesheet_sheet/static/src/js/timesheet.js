    ...
    instance.hr_timesheet_sheet.WeeklyTimesheet = instance.web.form.FormWidget.extend(instance.web.form.ReinitializeWidgetMixin, {
        ...
        initialize_content: function() {
            ...
            return this.render_drop.add(new instance.web.Model("account.analytic.line").call("default_get", [
                ...
                new instance.web.CompoundContext({'user_id': self.get('user_id'), "hr_timesheet" : 1 , "default_is_timesheet" : 1})]).then(function(result) {
                default_get = result;
                // calculating dates
                dates = [];
                    ...
                    if (!self.get('effective_readonly')) {
                        self.get_box(account, day_count).val(self.sum_box(account, day_count, true)).change(function() {
                            ...
                            if (isNaN(num)) {
                                ...
                                self.defs.push(new instance.web.Model("account.analytic.line").call("on_change_unit_amount", [[], product, account.days[day_count].lines[0].unit_amount, false, false, journal]).then(function(res) {
        ...
        init_add_account: function() {
            ...
            self.$(".oe_timesheet_weekly_add_row button").click(function() {
                ...
                new instance.web.Model("account.analytic.line").call("multi_on_change_account_id", [[], [id],
