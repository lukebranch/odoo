(function(){
    ...
    im_chat.Conversation = openerp.Widget.extend({
        ...
        _start_action_menu: function(){
            ...
            return (this.$('.oe_im_chatview_option_list li').length === 0);
        },
        _add_action: function(label, style_class, icon_fa_class, callback){
            ...
            if(callback){
                this.$('.oe_im_chatview_option_list .' + style_class).on('click', _.bind(callback, this));
            }
        },
        // ui
        show: function(){
        ...
        load_history: function(){
            ...
            if(this.loading_history){
                ...
                if(_.first(this.get("messages"))){
                    data["last_id"] = _.first(this.get("messages"));
                }
