...
class sale_quote(http.Controller):
    ...
    def template_view(self, quote, **post):
        sale_quotation_id = request.registry.get('ir.model.data').xmlid_to_res_id(request.cr, request.uid, 'website_quote.action_sale_quotation_template')
        values = {'template': quote, 'action': sale_quotation_id}
